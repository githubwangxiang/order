...
<section class="Psection MT20">
 <article class="Searchlist Overflow">
  <ul class="Overflow">
   <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li>
    ...
    <p class="P-shop Overflow">
        <span class="sa"><a href="/index.php/Home/Res/detail/id/<?php echo ($vol["id"]); ?>" target="_blank" title="<?php echo ($vol["res_name"]); ?>"><?php echo ($vol["res_name"]); ?></a></span>
        <span class="sp"><?php echo ($vol["res_city"]); ?></span></p>
    <p class="P-shop Overflow"><?php echo ($vol["res_city"]); ?>.<?php echo ($vol["res_address"]); ?></p>
 ...
 <aside class="Sraside">
  ...
  <ul>
      <?php if(is_array($tj)): $i = 0; $__LIST__ = $tj;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li>
            <a href="/index.php/Home/Res/detail/id/<?php echo ($vol["id"]); ?>" title="<?php echo ($vol["res_name"]); ?>" target="_blank"><img src="<?php echo ($vol["res_logo"]); ?>"></a>
            <p>
             <span class="Block FontW Font14">
                 <a href="/index.php/Home/Res/detail/id/<?php echo ($vol["id"]); ?>" title="<?php echo ($vol["res_name"]); ?>" target="_blank" class="CorRed"><?php echo ($vol["res_name"]); ?></a>
             </span>
             <span class="Block Overflow"><?php echo ($vol["res_city"]); ?></span>
             <span class="Block Overflow"><?php echo ($vol["res_city"]); ?>.<?php echo ($vol["res_area"]); echo ($vol["res_address"]); ?></span>
            </p>
           </li><?php endforeach; endif; else: echo "" ;endif; ?>
  </ul>
  </div>
