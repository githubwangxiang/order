...
<section class="Shop-index">
 <article>
  <div class="shopinfor">
   ...
   <div class="imginfor">
    <div class="shopimg">
     <img src="/Public/Home/upload/cc.jpg" id="showimg">
      <ul class="smallpic">
       <li><img src="/Public/Home/upload/cc.jpg" onmouseover="show(this)" onmouseout="hide()"></li>
      </ul>
    </div>
    <div class="shoptext">
    ...
    <div class="menutab show">
     <ul class="products">
		<li>
         ...
         <img src="/Public/Home/upload/01.jpg" class="foodsimgsize">
         </a>
          <a href="#" class="item">
		 <div>
		  <p>酸辣土豆丝</p>
		...
		<li>
		 <a href="detailsp.html" target="_blank" title="酸辣土豆丝">
         <img src="/Public/Home/upload/02.jpg" class="foodsimgsize">
         </a>
          <a href="#" class="item">
		 <div>
		  <p>酸辣土豆丝</p>
		...
		<li>
		 <a href="detailsp.html" target="_blank" title="酸辣土豆丝">
         <img src="/Public/Home/upload/04.jpg" class="foodsimgsize">
         </a>
          <a href="#" class="item">
		 <div>
		  <p>酸辣土豆丝</p>
		...
		<li>
		 <a href="detailsp.html" target="_blank" title="酸辣土豆丝">
         <img src="/Public/Home/upload/03.jpg" class="foodsimgsize">
         </a>
          <a href="#" class="item">
		 <div>
		  <p>酸辣土豆丝</p>
