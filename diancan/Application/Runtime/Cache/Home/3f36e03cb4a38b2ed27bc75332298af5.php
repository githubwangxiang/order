 ...
 <article class="U-article Overflow">
  ...
  <section class="usercenter">
   ...
   <div class="U-header MT20 Overflow">
    <img src="<?php echo ((isset($user["head"]) && ($user["head"] !== ""))?($user["head"]):'/Public/Uploads//head/2017-11-07/5a014246d4d36.jpg'); ?>">
    <p class="Font14 FontW"><?php echo ($user["user_name"]); ?>&ensp; 欢迎您回到 用户中心！</p>
    <p class="Font12">您的上一次登录时间:<time> <?php echo (date("Y-m-d",$user["last_time"])); ?></time></p>
    <p class="Font12 CorRed FontW"> | 我的积分( <?php echo ((isset($user["grade_num"]) && ($user["grade_num"] !== ""))?($user["grade_num"]):0); ?> )</p>
   </div>
    <!--<ul class="s-States Overflow FontW" id="Lbn">
     <li class="Font14 FontW">幸福业务在线提醒：</li>
     <li><a href="#">待付款( <?php echo ((isset($arr["wf"]) && ($arr["wf"] !== ""))?($arr["wf"]):0); ?> )</a></li>
     <li><a href="#">待发货( <?php echo ((isset($arr["wfh"]) && ($arr["wfh"] !== ""))?($arr["wfh"]):0); ?> )</a></li>
     <li><a href="#">已收货( <?php echo ((isset($arr["yfh"]) && ($arr["yfh"] !== ""))?($arr["yfh"]):0); ?>)</a></li>
     <li><a href="#">已收货( <?php echo ((isset($arr["ysh"]) && ($arr["ysh"] !== ""))?($arr["ysh"]):0); ?>)</a></li>
    </ul>-->
  </section>
 </article>
</section>
