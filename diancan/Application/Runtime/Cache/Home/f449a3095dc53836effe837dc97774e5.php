    ...
    <section class="Topmenubg">
        <div class="Topnav">
            <div class="LeftNav">
                ...
                <a href="/index.php/Home/User/register">注册</a>/<a href="/index.php/Home/User/login">登录</a>
  ...
  <div class="take-delivery">
   <div class="status">
     ...
     <div class="successInfo">
       <ul>
         <li>付款金额<em>¥<?php echo ($total); ?></em></li>
       </ul>
       <div class="option">
         <span class="info">您可以</span>
          <a href="/index.php/Home/Info/index" class="J_MakePoint" >进入<span>用户中心</span></a>
          <a href="/index.php/Home/Index/index" class="J_MakePoint">返回<span>首页</span></a>
       </div>
      </div>
    </div>
  </div>
