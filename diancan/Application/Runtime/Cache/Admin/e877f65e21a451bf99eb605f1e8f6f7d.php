...
<div class="page-container">
	<form action="/index.php/Admin/Food/edit" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>食物名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($food["food_name"]); ?>" placeholder="" id="fer" name="food_name">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<span class="select-box">
				<select name="res_id" class="select">
					...
					<?php if(is_array($restaurant)): $i = 0; $__LIST__ = $restaurant;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol["id"]); ?>" <?php if( $food["res_id"] == $vol["id"] ): ?>selected<?php endif; ?>><?php echo ($vol["res_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</span>
			</div>
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" name="food_nowprice" id="" placeholder="" value="<?php echo ($food["food_nowprice"]); ?>" class="input-text" style="width:90%">
			元</div>
	</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>市场价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="food_price" id="" placeholder="" value="<?php echo ($food["food_price"]); ?>" class="input-text" style="width:90%">
				元</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>销量：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($food["food_sale"]); ?>" placeholder="" id="articlesort" name="food_sale">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea id="editor" name="food_introduce" type="text/plain" style="width:100%;height:400px;"><?php echo ($food["food_introduce"]); ?></textarea>
			</div>
		</div>
		<div class="row cl">
