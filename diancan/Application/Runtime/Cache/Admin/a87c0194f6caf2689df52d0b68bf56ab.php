...
<div class="page-container">
	<form action="/index.php/Admin/Food/add" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<span class="select-box">
				<select name="res_id" class="select">
					...
					<?php if(is_array($restaurant)): $i = 0; $__LIST__ = $restaurant;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol["id"]); ?>"><?php echo ($vol["res_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</span>
			</div>
		</div>
